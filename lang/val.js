export default {
  hero: {
    title: 'Suma’t',
    leadin: 'Ara més que mai et necessitem per protegir tot allò aconseguit, i la millor manera de fer-ho és amb la teua implicació, il·lusió i desig de canvi. Uneix-te i sigues part d’este projecte. Ens ajudes?'
  },
  party: {
    title: 'Partit',
